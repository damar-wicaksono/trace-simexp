...
at which the model will be evaluated; as well as its analysis, in particular
the analysis of the output variation in relation to the inputs variation, are
...
experiments for the thermal-hydraulics system code TRACE. The scope of the
utility is ranging from the pre-processing of the TRACE input deck amenable for
batch parallel execution to the post-treatment of the resulting binary xtv/dmx
file amenable to subsequent sensitivity and uncertainty analyses. This
documentation describes the development of the tool, including the description
of its usage, implementations, and assumptions.
